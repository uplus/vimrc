" https://gist.github.com/t9md/f7735478d8440ba6b6a08e6ebda0eadb
...
let s:features = [
      ...
      \ 'encoding', 'percent', 'line_col', 'as_is' ]
...
function! s:parts.__init() "{{{1
  ...
  if self.__filetype is# 'unite'
    let self.__layout = '|1 as_is::Unite |2 unite_buffer_name |2 unite_status'
    return
  endif
